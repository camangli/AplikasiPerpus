...
<body>
<h3>Cari Transaksi Peminjaman Buku</h3>
<div id="cont-peminjaman">
<div id="up-peminjaman">
<form action="" method="post">
    <input type="hidden" name="bywhat" value="byKode"/>
    <input type="text" name="byKode" class="border" placeholder="Kode Peminjaman" required="required"/>
